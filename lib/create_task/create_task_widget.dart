                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FlutterFlowChoiceChips(
                                    options: [
                                      ChipData('Low', Icons.low_priority),
                                      ChipData('Medium',
                                          Icons.pivot_table_chart_outlined),
                                      ChipData('High', Icons.priority_high),
                                      ChipData('Important ', Icons.star),
                                      ChipData('Must-Do', Icons.run_circle),
                                      ChipData('Urgent', Icons.quickreply_sharp)
                                    ],
                                    onChanged: (val) => safeSetState(() =>
                                        _model.priorityChoiceChipsValue =
                                            val?.firstOrNull),
                                    ...
                                    multiselect: false,
                                    initialized:
                                        _model.priorityChoiceChipsValue != null,
                                    alignment: WrapAlignment.start,
                                    controller: _model
                                            .priorityChoiceChipsValueController ??=
                                  ...
                                  FlutterFlowChoiceChips(
                                    ...
                                    multiselect: false,
                                    initialized:
                                        _model.statusChoiceChipsValue != null,
                                    alignment: WrapAlignment.start,
                                    controller: _model
                                            .statusChoiceChipsValueController ??=
                                        FormFieldController<List<String>>(
                                      ['Pending'],
                                    ),
                                    wrapped: true,
                      ...
                      onPressed: () async {
                        ...
                        await TasksRecord.collection
                            ...
                            .set(createTasksRecordData(
                              ...
                              status: _model.statusChoiceChipsValue,
                              priority: _model.priorityChoiceChipsValue,
                        ...
                        safeSetState(() {
                          _model.priorityChoiceChipsValueController?.reset();
                          _model.statusChoiceChipsValueController?.reset();
                        });
