...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: PendingTasksPageWidget.routeName,
          path: PendingTasksPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'PendingTasksPage')
              : PendingTasksPageWidget(),
        ),
        FFRoute(
          name: CompletedTasksPageWidget.routeName,
          path: CompletedTasksPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'CompletedTasksPage')
              : CompletedTasksPageWidget(),
        ),
        FFRoute(
          name: InProgressTasksPageWidget.routeName,
          path: InProgressTasksPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'InProgressTasksPage')
              : InProgressTasksPageWidget(),
        )
